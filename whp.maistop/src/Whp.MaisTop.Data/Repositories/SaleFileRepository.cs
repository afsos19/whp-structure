...
{
    public class SaleFileRepository : Repository<SaleFile>, ISaleFileRepository
    {
        public SaleFileRepository(WhpDbContext context) : base(context)
        {
        }
        ...
        public async Task<(IEnumerable<SaleFile> Rows, int Count)> GetSaleFile(int start, int limit,int currentMonth, int currentYear, int network, int fileStatusId)
        {
            var query = _dbContext.Set<SaleFile>() as IQueryable<SaleFile>;
        ...
        public async Task<IEnumerable<SaleFile>> GetSaleFile(int currentMonth, int currentYear, int network, int fileStatusId)
        {
            var query = _dbContext.Set<SaleFile>() as IQueryable<SaleFile>;
