...
{
    public class TrainingUserRepository : RepositoryAcademy<TrainingUser>, ITrainingUserRepository
    {
        public TrainingUserRepository(WhpAcademyDbContext context) : base(context)
        {
        }
    }
}
